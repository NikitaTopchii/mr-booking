...
export const dictionary = {
  ...
  schedule: {
    ...
    minimumCapacityLabel: 'Мінімальна місткість',
    minimumCapacityPlaceholder: 'Осіб',
    applyCapacityFilter: 'Застосувати фільтр',
    clearCapacityFilter: 'Очистити фільтр',
    activeCapacity: 'Фільтр місткості активний',
    invalidCapacity: 'Введіть додатне ціле число осіб.',
    noMatchingRooms: 'Немає кімнат щонайменше на {capacity} осіб.',
    filterButtonLabel: 'Фільтрувати кімнати за місткістю',
    currentFilterSummary: 'Показано кімнати щонайменше на {capacity} осіб.',
